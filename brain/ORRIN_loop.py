...
def run_cognitive_loop(
    ...
    # Background daemons (ToolRunner, Evaluator, Layer-0 embodiment, Executive),
    # extracted to brain/loop/services.py (Phase 4A).
    _tool_runner, _ToolRunner_cls, _evaluator = start_background_services(stop_event)
