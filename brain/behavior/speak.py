...
# Pre-class speech helpers, extracted to speak_helpers.py (Phase 4.5C).
# Re-imported for the OrrinSpeaker class + external callers (talk_policy).
from brain.behavior.speak_helpers import (  # noqa: F401
    _LEADING_TS_RE, _opinion_hook, _your_world_hook, _clean_content,
    filter_memories, _derive_tone,
)
