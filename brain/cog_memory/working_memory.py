...
# (Phase 4.5C). Re-imported for update_working_memory + external callers
# (prediction, clean_corrupted_memory).
from brain.cog_memory.working_memory_chunk import (  # noqa: F401
    _content_similarity, _MIN_CHUNK_SIM, _strip_chunk_label, _chunk_two_most_similar,
)
