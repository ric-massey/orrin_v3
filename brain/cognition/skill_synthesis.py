...
# Synthesized-skill verification gauntlet, extracted to skill_verification.py
# (Phase 4.5C). Re-imported for synthesize_skill + external callers
# (self_extension_codegen, code_writer).
from brain.cognition.skill_verification import (  # noqa: F401
    _SafetyVisitor, _run_safety_check, check_code_safety, _run_execution_check,
    _run_behavioral_review, verify_skill,
)
