...
# Felt-time surface text (templates + builder), extracted to
# temporal_state_surface.py (Phase 4.5C). Re-imported for update_temporal_state.
from brain.cognition.temporal_state_surface import _build_surface_text  # noqa: E402,F401
