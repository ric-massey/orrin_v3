...
`brain/peers/` implements the outside observers described in [Peers](Peers.md): entities that read
...
emit signals, not state mutations. Walkthrough: [Adding a Custom Peer](Adding_Custom_Peer.md).
